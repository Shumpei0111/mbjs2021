      ...
      <div className={style.aboutContainer}>
        <div className={style.aboutVisual}>
          <div className={style.names}>
            ...
            <p className={`${style.profile__baseIn} ${style.profile__iam}`}>
              Base In Tokyo, Japan
            </p>
            ...
            <ul className={style.profle__snsList}>
              <li>
                <Link
                  ...
                  rel="noopener"
                >
                  <FontAwesomeIcon icon={faTwitter} />/ @seventhseven
                </Link>
              </li>
              <li>
                <Link
                  ...
                  rel="noopener"
                >
                  <FontAwesomeIcon icon={faGithub} />/ Shumpei0111
                </Link>
              </li>
              <li>
                <Link
          ...
          <div
            className={`${style.profile__img} ${fadein.animation} ${
        ...
        <div className={style.profile__detail}>
          ...
          <div className={style.profile__detail__wrapper}>
            ...
            <p className={style.profile__detail__item}>一児の父。</p>
          </div>
        </div>
      </div>
      <TopMarquee />
