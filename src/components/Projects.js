      ...
      <div className={style.projects__mainContents}>
        ...
        <div className={`${style.projects__genreContainer}`}>
          ...
          <ul className={style.projects__list}>
            ...
            <li>
              <p
                className={`${style.projects__name} ${style.projects__num} ${style.projects__num2}`}
              >
                廃校探索
              </p>
              <div className={style.projects__item}>
                <Link
                  href="https://hoshikake-obake.site/"
                  rel="noopener"
                  target="_blank"
                >
              ...
              <div className={style.projects__captionWrapper}>
                <div className={style.projects__overviewWrapper}>
                  <h4>概要</h4>
                  <p className={style.projects__pjCaption}>
                    Twitter上の企画：星駆web制作企画に参加。「お化け屋敷」と簡単な設定をもとに、
                    <br />
                    約1ヶ月で調査、コンセプト作成、デザイン、実装、ライティングまで独自で行う。
                  </p>
            ...
            <li>
              <p
                className={`${style.projects__name} ${style.projects__num} ${style.projects__num3}`}
              >
                PRESENT RESORT POINT
              </p>
              <div className={style.projects__item}>
                <Link
                  href="https://present-resort-point.tokyo/"
                  rel="noopener"
                  target="_blank"
                >
                  <ProjectImage
              ...
              <div className={style.projects__captionWrapper}>
                <div className={style.projects__overviewWrapper}>
                  <h4>概要</h4>
                  <p className={style.projects__pjCaption}>
                    １週間でWebサービスを作るイベント#web1week に参加。
                    <br />
                    「世界のリゾート地にあるライブカメラでリゾート気分を味わう」をコンセプトに制作。
                  </p>
                ...
                <ul className={style.projects__pj__stack}>
                  ...
                  <li>
                    <Link
                      href="https://github.com/Shumpei0111/resort_anthem"
                      target="_blank"
                      rel="noopener"
                    >
                      GitHub
            ...
            <li>
              <p
                className={`${style.projects__name} ${style.projects__num} ${style.projects__num4}`}
              >
                VILLAINS HOMME
              </p>
              <div className={style.projects__item}>
                <Link
                  href="https://villains-homme.web.app/"
                  rel="noopener"
                  target="_blank"
                >
                  <ProjectImage
              ...
              <div className={style.projects__captionWrapper}>
                <div className={style.projects__overviewWrapper}>
                  <h4>概要</h4>
                  <p className={style.projects__pjCaption}>
                    Twitter上の企画：架空の10代〜20代向けメンズコスメブランド
                    <br />
                    「VILLAINS HOMME（ヴィランズ オム）」のLP。
                  </p>
                ...
                <ul className={style.projects__pj__stack}>
                  ...
                  <li>
                    <Link
                      href="https://github.com/Shumpei0111/villains_homme"
                      target="_blank"
                      rel="noopener"
                    >
                      GitHub
        ...
        <div className={`${style.projects__genreContainer}`}>
          ...
          <div className={style.projects__presentTop}>
            <p className={style.projects__pjCaption}>
              複数のオンラインコミュニティでLT（20分）をしたり、レクチャーをする機会がありました。
            </p>
            <p className={style.projects__pjCaption}>
              その際、セキュリティについてのレクチャーはWebサイト化しているので掲載します。
            </p>
          </div>
          <div>
            <ul className={style.projects__list}>
              <li>
                ...
                <ul>
                  <li>
                    <Link
                      href="https://frontend-lecture.vercel.app/"
                      target="_blank"
                  ...
                  <li>
                    <Link
                      href="https://lecture-cookie-memo.vercel.app/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <p className={style.projects__pjCaption}>
        ...
        <div className={`${style.projects__genreContainer}`}>
          ...
          <div className={style.projects__circleTop}>
            ...
            <p className={style.projects__pjCaption}>
              【ファッションイラスト×アニメ】をコンセプトに、同人サークル「1月の朝」で
              <br />
              ガルパン（ガールズアンドパンツァー）やプリキュアなどの二次創作をしています。
              <br />
          ...
          <div className={style.projects__circle}>
            ...
            <ul className={style.projects__list}>
              <li>
                ...
                <div className={style.projects__item}>
                  <Link
                    href="https://www.pixiv.net/artworks/59232048"
                    rel="noopener"
                    target="_blank"
                  >
                    <ProjectImage
                ...
                <div className={style.projects__circle__distribution}>
                  <div className={style.projects__overviewWrapper}>
                    <h4>概要</h4>
                    <p className={style.projects__circle__genreName}>
                      GENRE：ガールズ&パンツァー
                    </p>
                    <p>
                      西 ×
                      ダジ本。相手を好きな気持ちに理由なんてない。そんな感情をぶつける2人の乙女の話。
                      <br />
                      他、ポストカード数種と色紙
                    </p>
                    <SeeWebSite
              ...
              <li>
                ...
                <div className={style.projects__item}>
                  <Link
                    href="https://www.pixiv.net/artworks/57371698"
                    rel="noopener"
                    target="_blank"
                  >
                    <ProjectImage
              ...
              <li>
                ...
                <div className={style.projects__item}>
                  <Link
                    href="https://www.pixiv.net/artworks/55104947"
                    rel="noopener"
                    target="_blank"
                  >
                    <ProjectImage
                ...
                <div className={style.projects__circle__distribution}>
                  <div className={style.projects__overviewWrapper}>
                    ...
                    <p>
                      大本営から「鎮守府をPRセヨ」という命令が与えられた鎮守府。
                      <br />
                      秘書艦の鳥海に押し付けたら、他の艦娘の協力もあって無事PR動画！...と思われたが。という本。
                    </p>
                    <SeeWebSite
                      type="pixiv"
